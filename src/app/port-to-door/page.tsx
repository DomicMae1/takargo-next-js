...
export default function PortToDoor() {
    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="relative min-h-screen bg-[#FAFAFA]">
          ...
          <div className="relative w-full h-[300px] flex items-center px-24">
            ...
            <div className="relative z-10 text-center text-black">
              <h1 className="text-5xl font-semibold">
                Layanan LCL <span className="text-[#0891B2]">Port to Door</span>{" "}
                Takargo
              </h1>
              <p className="text-2xl mt-4 font-normal px-32">
                Jasa Pengiriman Barang Door to Door dari Takargo memungkinkan
                kamu untuk mengirim dan menerima barang tanpa perlu repot keluar
                rumah. Cukup buat order dan atur jadwal, dan kami akan datang ke
                rumah untuk mengambil barang Anda dan mengantar hingga ke rumah
                penerima.
              </p>
            </div>
          </div>
          ...
          {/* ================== Row 2 ================== */}
          <div className="relative w-full px-24 pb-18 space-y-4 flex items-center justify-center">
            <img
              src="/port-to-door.svg"
              alt="Port to Door"
              className="h-[450px] w-auto"
            />
          </div>

          {/* ================== Row 3 (Pertanyaan & Jawaban) ================== */}
          <div className="relative w-full px-24 space-y-6 text-left">
            {/* Syarat & Ketentuan */}
            <div className="rounded-2xl p-6">
              <h3 className="text-4xl font-bold text-[#0891B2] mb-4">
                Syarat & Ketentuan
              </h3>
              <ul className="list-disc list-inside text-gray-600 text-base space-y-1 mb-12">
                <li>
                  Menjemput dan mengantar ke tempat Customer, minimum
                  penjemputan barang 1 kg
                </li>
                <li>Lokasi penjemputan bisa dilewati mobil box</li>
                <li>Lokasi Pengiriman bisa dilewati mobil box</li>
                <li>H-1 booking penjemputan</li>
              </ul>
            </div>
          </div>
        </section>
