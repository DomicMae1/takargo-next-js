          ...
          <div className="relative w-full h-[300px] flex items-center px-24">
            ...
            <div className="relative z-10 text-center text-black">
              <h1 className="text-5xl font-semibold">
                Layanan LCL <span className="text-[#0891B2]">Door to Port</span>{" "}
                Takargo
              </h1>
              <p className="text-2xl mt-4 font-normal px-32">
                Jasa Pengiriman Barang Door to Port dari Takargo adalah solusi
                bagi anda yang tidak ingin repot dan lebih hemat biaya. Anda
                cukup tunggu kurir datang mengambil barang lalu akan kami
                kirimkan ke kantor takargo di daerah tujuan.
              </p>
            </div>
          </div>
